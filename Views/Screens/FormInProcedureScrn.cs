...
namespace Screens
{
    public class FormInProcedureScrn : Form
    {
        ...
        public FormInProcedureScrn()
        {
            this.lblUser = new Fields.LabelFieldTam("Cadastrar Procedimento", 80, 15, 150, 30);

            this.DescricaoProcedimento = new Fields.LabelField("Descrição:", 50, 40);
            this.txtDescricaoProcedimento = new Fields.TextBoxField(50, 70, 200, 20);

            this.PrecoProcedimento = new Fields.LabelFieldTam("Preço:", 50, 100, 150, 30);
            this.txtPrecoProcedimento = new Fields.TextBoxField(50, 130, 200, 20);
