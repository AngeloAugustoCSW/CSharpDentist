...
namespace Screens
{
    public class FormInDentistScrn : Form
    {
        ...
        public FormInDentistScrn()
        {
            this.lblUser = new Fields.LabelFieldTam("Cadastrar Dentista", 200, 15, 150, 30);
            ...
            this.Registro = new Fields.LabelFieldTam("Registro:", 250, 40, 150, 30);
            this.txtRegistro = new Fields.TextBoxField(250, 70, 180, 20);

            this.Salario = new Fields.LabelFieldTam("Salario:", 250, 100, 150, 30);
            this.txtSalario = new Fields.TextBoxField(250, 130, 180, 20);

            this.EspecialidadeId = new Fields.LabelFieldTam("Especialidade Id:", 250, 160, 150, 30);
            this.txtEspecialidadeId = new Fields.TextBoxField(250, 190, 180, 20);
